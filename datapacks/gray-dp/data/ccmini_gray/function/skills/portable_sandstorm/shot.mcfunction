#發射瓶子
playsound minecraft:entity.splash_potion.throw player @a ~ ~ ~ 0.5 0.5
summon item ~ ~ ~ {Item:{id:"white_dye",components:{item_model:"gray_empty"}},Age:-32768,PickupDelay:32767,Passengers:[{id:"item_display",item:{id:"white_dye",components:{item_model:"minecraft:gray_portable_sandstorm"}},Tags:[new,portable_sandstorm],transformation:{left_rotation:[0.0,0.0,0.0,1.0],right_rotation:[0.0,0.0,0.0,1.0],scale:[1.5,1.5,1.5],translation:[0.0,0.5,0.0]}}],Tags:[motion.new]}
execute rotated as @s as @e[type=item_display,tag=new] positioned as @s run rotate @s ~ 0
