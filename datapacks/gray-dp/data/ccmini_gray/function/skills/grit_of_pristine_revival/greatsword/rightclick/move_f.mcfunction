execute rotated ~ 0 positioned ^ ^ ^20 run summon marker ~ ~ ~ {Tags:[gray.PosMarker]}
execute rotated ~ 0 positioned ^ ^ ^3 facing entity @s feet rotated ~180 ~ run function animated_java:gray_speed_lines/summon {args:{animation:"run",start_animation:true}}
