...
,attributes:[{id:max_health,base:20},{id:"attack_damage",base:0},{id:follow_range,base:30}],DeathLootTable:"light_green:piglin",CustomName:{translate:"light_green:piglin_shield"}}
