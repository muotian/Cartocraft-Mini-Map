...
execute if score @s light_green.main.math matches 19 run return run function light_green:mob/small_golem/ground_laser/summon

execute if score @s light_green.main.math matches 15.. run return run function light_green:mob/small_golem/ground_laser/ready/remove
