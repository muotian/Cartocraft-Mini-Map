execute as @e[tag=aj.piglin_girl.root,limit=1,distance=..30] run function animated_java:piglin_girl/animations/dagger_throw2/play
...
scoreboard players set @s light_green.boss.attack_type 13
...
item replace entity @n[tag=light_green.l_weapon] container.0 with stick[item_model="light_green:golden_dagger"]
item replace entity @n[tag=light_green.r_weapon] container.0 with air