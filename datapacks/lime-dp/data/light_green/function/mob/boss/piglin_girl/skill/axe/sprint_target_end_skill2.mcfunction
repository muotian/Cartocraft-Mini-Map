execute as @e[tag=aj.piglin_girl.root,limit=1,distance=..30] run function animated_java:piglin_girl/animations/axe_sprint_attack/play
scoreboard players set @s light_green.boss.animation 34
scoreboard players set @s light_green.boss.attack_type 35
