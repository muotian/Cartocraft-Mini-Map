...
execute at @s rotated as caba-0-0-0-1 positioned ^ ^ ^7 run function light_green:mob/boss/piglin_girl/animation/axe/earth_quack/2 with storage light_green:smoke
