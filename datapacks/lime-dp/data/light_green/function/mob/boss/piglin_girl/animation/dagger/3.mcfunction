...
execute if score @s light_green.boss.animation matches 1 run attribute @s movement_speed modifier add light_green:piglin_girl_attack 0.65 add_value
...
execute if score @s light_green.boss.animation matches 0 unless score $piglin_girl_dagger light_green.main.math = $piglin_girl_dagger_target light_green.main.math run function light_green:mob/boss/piglin_girl/skill/dagger/1
