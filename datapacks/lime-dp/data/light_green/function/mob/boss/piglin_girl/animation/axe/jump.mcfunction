...
execute if score @s light_green.boss.animation matches 14 run playsound minecraft:item.armor.equip_netherite hostile @a ~ ~ ~ 1 1.5
execute if score @s light_green.boss.animation matches 12 run playsound minecraft:entity.ender_dragon.flap hostile @a ~ ~ ~ 3 1
