...
execute if score @s light_green.boss.animation matches ..1 if score $Onground light_green.main.math matches 1 run function light_green:mob/boss/piglin_girl/skill/axe/back_jump_end