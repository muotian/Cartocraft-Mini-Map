...
scoreboard players operation @n[tag=light_green.new.mob] light_green.custom.health += $piglin_girl.modify.base light_green.main.math
...
execute if score $pc light_green.main.math matches 1.. run return run function light_green:mob/boss/piglin_girl/start_health/1