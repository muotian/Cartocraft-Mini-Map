scoreboard players set @s light_green.boss.animation 291
...
execute unless score $piglin_girl_defeated light_green.main.math matches 1 run tellraw @a[tag=light_green.boss.challenger] {text:""}
execute unless score $piglin_girl_defeated light_green.main.math matches 1 run tellraw @a[tag=light_green.boss.challenger] {text:""}
execute unless score $piglin_girl_defeated light_green.main.math matches 1 run tellraw @a[tag=light_green.boss.challenger] {text:""}
execute unless score $piglin_girl_defeated light_green.main.math matches 1 run tellraw @a[tag=light_green.boss.challenger] {text:""}
execute unless score $piglin_girl_defeated light_green.main.math matches 1 run tellraw @a[tag=light_green.boss.challenger] {text:""}
