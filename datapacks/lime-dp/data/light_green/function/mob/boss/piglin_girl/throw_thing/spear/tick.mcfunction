...
execute if entity @s[tag=light_green.from_player] run function light_green:mob/boss/piglin_girl/throw_thing/spear/get_damage with storage light_green:weapon

execute if entity @s[tag=light_green.hit] run return fail
execute at @s if block ^ ^ ^0.5 #light_green:not run tp @s ^ ^ ^0.5
execute at @s unless block ^ ^ ^0.5 #light_green:not positioned ^ ^ ^-1 run function light_green:mob/boss/piglin_girl/throw_thing/spear/down
function light_green:mob/boss/piglin_girl/throw_thing/spear/damge
execute if entity @s[tag=light_green.hit] run return fail
execute at @s if block ^ ^ ^0.5 #light_green:not run tp @s ^ ^ ^0.5
execute at @s unless block ^ ^ ^0.5 #light_green:not positioned ^ ^ ^-1 run function light_green:mob/boss/piglin_girl/throw_thing/spear/down
function light_green:mob/boss/piglin_girl/throw_thing/spear/damge
