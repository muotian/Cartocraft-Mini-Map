...
execute if score @s light_green.boss.animation matches 35 run playsound minecraft:item.armor.equip_netherite hostile @a ~ ~ ~ 1 1.5
execute if score @s light_green.boss.animation matches 30 run tag @s add light_green.crack_apply
execute if score @s light_green.boss.animation matches 30 run function light_green:mob/boss/piglin_girl/animation/axe/earth_quack/0 with storage light_green:smoke
execute if score @s light_green.boss.animation matches 30 run tag @s remove light_green.crack_apply
execute if score @s light_green.boss.animation matches 30 run playsound minecraft:entity.ender_dragon.flap hostile @a ~ ~ ~ 3 1
execute if score @s light_green.boss.animation matches 30 run playsound minecraft:entity.generic.explode hostile @a ~ ~ ~ 2 1
execute if score @s light_green.boss.animation matches 10 run function light_green:mob/boss/piglin_girl/animation/axe/earth_quack/0 with storage light_green:smoke
execute if score @s light_green.boss.animation matches 10 run playsound minecraft:entity.ender_dragon.flap hostile @a ~ ~ ~ 3 1
execute if score @s light_green.boss.animation matches 10 run playsound minecraft:entity.generic.explode hostile @a ~ ~ ~ 2 1
