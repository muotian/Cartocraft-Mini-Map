...
execute if score @s light_green.boss.animation matches 0 unless score $piglin_girl_dagger light_green.main.math = $piglin_girl_dagger_target light_green.main.math run function light_green:mob/boss/piglin_girl/skill/dagger/2
