...
execute if score $random light_green.main.math matches 1 run return run function light_green:mob/boss/piglin_girl/skill/axe/jump_end_late
execute as @e[tag=aj.piglin_girl.root,limit=1,distance=..30] run function animated_java:piglin_girl/animations/axe_jump_end/play
...
scoreboard players set @s light_green.boss.attack_type 44
