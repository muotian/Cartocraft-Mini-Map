...
$execute as @e[tag=light_green.damage_target] run damage @s $(damage) light_green:axe_throw by @p[scores={light_green.player_id=$(id)}]
execute as @e[tag=light_green.damage_target] run function light_green:break_defance/apply
