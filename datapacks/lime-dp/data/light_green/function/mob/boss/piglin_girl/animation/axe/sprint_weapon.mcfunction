...
execute if entity @n[tag=light_green.boss.piglin_girl.sprint_target,distance=..3.25] run function light_green:mob/boss/piglin_girl/skill/axe/sprint_weapon_end