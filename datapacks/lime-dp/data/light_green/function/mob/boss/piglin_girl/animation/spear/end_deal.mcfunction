...
execute if score @s light_green.boss.animation matches 13 run playsound minecraft:item.armor.equip_netherite hostile @a ~ ~ ~ 1 1
...
execute if score @s light_green.boss.animation matches 3 run playsound minecraft:entity.ender_dragon.flap hostile @a ~ ~ ~ 1.5 1.5
