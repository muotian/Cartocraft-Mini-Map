...
execute if entity @n[tag=light_green.boss.piglin_girl.sprint_target,distance=..3.25] if score $piglin_girl_skill2 light_green.main.math matches 1 run function light_green:mob/boss/piglin_girl/skill/axe/sprint_target_end_skill2
execute if entity @n[tag=light_green.boss.piglin_girl.sprint_target,distance=..3.25] unless score $piglin_girl_skill2 light_green.main.math matches 1 run function light_green:mob/boss/piglin_girl/skill/axe/sprint_target_end