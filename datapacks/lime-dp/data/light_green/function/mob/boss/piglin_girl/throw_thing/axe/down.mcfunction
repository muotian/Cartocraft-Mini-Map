...
data modify entity @s item set value {id:golden_spear,components:{item_model:"light_green:double_axe"}}
data modify entity @s transformation set value {left_rotation:[0.366,-0.061,0.816,-0.443],right_rotation:[0,0,0,1],translation:[0.307,0.300,-0.090],scale:[1.5,1.5,1.5]}
