execute if score @s light_green.boss.animation matches 38 run tag @s add light_green.crack_apply
execute if score @s light_green.boss.animation matches 38 run function light_green:mob/boss/piglin_girl/animation/axe/earth_quack/0 with storage light_green:smoke
execute if score @s light_green.boss.animation matches 38 run tag @s remove light_green.crack_apply
execute if score @s light_green.boss.animation matches 38 as @e[tag=aj.piglin_girl_head.root,limit=1,distance=..30] run function animated_java:piglin_girl_head/animations/battle/play
execute if score @s light_green.boss.animation matches 38 run playsound minecraft:entity.generic.explode hostile @a ~ ~ ~ 2 1
execute if score @s light_green.boss.animation matches 18 run function light_green:mob/boss/piglin_girl/animation/axe/earth_quack/0 with storage light_green:smoke
execute if score @s light_green.boss.animation matches 18 as @e[tag=aj.piglin_girl_head.root,limit=1,distance=..30] run function animated_java:piglin_girl_head/animations/battle/play
execute if score @s light_green.boss.animation matches 18 run playsound minecraft:entity.generic.explode hostile @a ~ ~ ~ 2 1
