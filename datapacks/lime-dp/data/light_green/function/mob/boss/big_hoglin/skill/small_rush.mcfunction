execute as @e[tag=aj.big_hoglin.root,limit=1,distance=..30] run function animated_java:big_hoglin/animations/run1/play
...
scoreboard players set @s light_green.boss.animation 51