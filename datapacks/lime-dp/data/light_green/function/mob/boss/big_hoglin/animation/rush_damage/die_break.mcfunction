...
execute as @e[tag=light_green.target] run damage @s 6 light_green:rush by @n[tag=light_green.boss.big_hoglin]
...
function light_green:mob/boss/big_hoglin/rush_summon/blood/summon