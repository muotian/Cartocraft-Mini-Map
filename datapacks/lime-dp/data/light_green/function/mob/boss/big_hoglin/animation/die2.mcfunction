...
execute if score @s light_green.boss.animation matches 0 unless score $kill_hoglin light_green.main.math matches 1 run function light_green:item/hoglin_teeth
