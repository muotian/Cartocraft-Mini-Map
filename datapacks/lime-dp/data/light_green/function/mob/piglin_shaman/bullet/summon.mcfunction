...
$execute anchored eyes positioned ^ ^ ^ run summon marker ~ ~-0.5 ~ {Tags:["light_green","light_green.mob","light_green.shaman_bullet","light_green.new.mob","light_green.bullet.$(tag)"]}
...
function light_green:mob/piglin_shaman/bullet/tag with storage light_green:mob
