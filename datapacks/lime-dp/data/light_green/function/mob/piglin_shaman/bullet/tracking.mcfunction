...
execute at @s run function light_green:mob/piglin_shaman/bullet/hit
$execute if entity @s[tag=!light_green.bullet.guard] if entity @n[tag=light_green.bullet.$(id).target,dx=0] run function light_green:mob/piglin_shaman/bullet/kill with storage light_green:mob
$execute if entity @s[tag=light_green.bullet.guard] if entity @n[tag=light_green.bullet.$(id).target,dx=0] run function light_green:mob/piglin_shaman/bullet/kill_guard with storage light_green:mob

function light_green:mob/piglin_shaman/bullet/particle with storage light_green:mob
