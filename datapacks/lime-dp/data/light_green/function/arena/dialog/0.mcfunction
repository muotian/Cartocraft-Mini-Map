...
execute if entity @s[tag=light_green.boss.challenger] unless score $piglin_girl.already light_green.main.math matches 1 run return run dialog show @s {type:multi_action,title:'',body:[\
...
execute if entity @s[tag=light_green.boss.challenger] if score $piglin_girl.already light_green.main.math matches 1 run return run dialog show @s {type:multi_action,title:'',body:[\
{type:plain_message,contents:[{"translate":"light_green:arena_dialog","color":"white"}]},\
{type:plain_message,contents:[{"translate":"light_green:arena_shield","color":"gray"}]},\
{type:plain_message,contents:[{"text":""}]}\
],\
