...
actions:[\
{label:{"translate":"options.difficulty.easy"},action:{type:"run_command",command:'trigger light_green.difficulty_piglin_level set 1'},width:200},\
{label:{"translate":"options.difficulty.normal"},action:{type:"run_command",command:'trigger light_green.difficulty_piglin_level set 2'},width:200},\
{label:{"translate":"options.difficulty.hard"},action:{type:"run_command",command:'trigger light_green.difficulty_piglin_level set 3'},width:200}],\
