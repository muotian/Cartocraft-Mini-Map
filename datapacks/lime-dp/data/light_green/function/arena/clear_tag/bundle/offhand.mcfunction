...
item replace entity @s weapon.offhand from entity 0-0-0-0-2 container.0
execute store result storage light_green:arena bundle int 1 run scoreboard players add $bundle light_green.main.math 1
function light_green:arena/clear_tag/bundle/offhand with storage light_green:arena