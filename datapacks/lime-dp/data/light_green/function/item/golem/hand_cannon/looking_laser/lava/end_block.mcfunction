...
execute if score $rotate light_green.main.math matches 50.. at @p[tag=light_green.hand_cannon.user] at @n[type=!#light_green:no_hp,distance=..10,type=!player] run function light_green:item/golem/hand_cannon/ground_laser/ready/lava