...
execute at @s run playsound minecraft:block.conduit.activate player @s ~ ~ ~ 2 2
tag @s add light_green.hand_cannon.user
execute at @s anchored eyes positioned ^ ^ ^ run function light_green:item/golem/hand_cannon/laser_wave/water/summon
