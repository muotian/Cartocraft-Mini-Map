...
execute if entity @s[tag=light_green.lava] store result entity @s transformation.scale[0] int 1 run scoreboard players remove $laser_width light_green.main.math 2
