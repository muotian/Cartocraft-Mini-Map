...
execute unless block ^ ^ ^1 #light_green:not positioned ~ ~ ~ run return run function light_green:item/golem/hand_cannon/looking_laser/lava/end_block
execute if score $looking_laser light_green.main.math matches 25.. run return run function light_green:item/golem/hand_cannon/looking_laser/lava/end
execute unless score $looking_laser light_green.main.math matches 25.. positioned ^ ^ ^1 run function light_green:item/golem/hand_cannon/looking_laser/lava/1