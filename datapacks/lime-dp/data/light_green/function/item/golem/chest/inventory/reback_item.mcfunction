...
execute unless score $armor_item_level light_green.main.math matches 2.. if score $minecraft:diamond light_green.main.math matches 1 run function light_green:item/golem/chest/inventory/to_long with storage light_green:golem_item
execute unless score $armor_item_level light_green.main.math matches 3.. if score $minecraft:netherite_ingot light_green.main.math matches 1 run function light_green:item/golem/chest/inventory/to_gloves with storage light_green:golem_item
