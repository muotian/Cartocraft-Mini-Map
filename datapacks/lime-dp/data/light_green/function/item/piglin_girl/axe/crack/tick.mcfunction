...
execute if score @s light_green.main.math matches 20 store result storage light_green:player id int 1 run scoreboard players get @s light_green.player_id
execute if score @s light_green.main.math matches 20 run function light_green:item/piglin_girl/axe/crack/damage with storage light_green:player

execute if score @s light_green.main.math matches 220.. run return run function light_green:item/piglin_girl/axe/crack/kill
...
function light_green:item/piglin_girl/axe/crack/target_senser/ with storage light_green:boss

function light_green:item/piglin_girl/axe/crack/remove_entering_state with storage light_green:boss
...
execute as @e[tag=light_green.crack_hit] unless score @s light_green.crack matches 1.. run function light_green:mob/boss/piglin_girl/cant_move/apply
