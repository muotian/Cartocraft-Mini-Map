$data modify storage light_green:weapon player.$(id).spear set from entity @s SelectedItem
$execute unless items entity @s weapon.mainhand *[enchantments~[{"enchantments": "light_green:left_click"}]] store result storage light_green:weapon player.$(id).spear_damage double 0.01 run attribute @s attack_damage get 100
...
execute if items entity @s container.* *[custom_data~{light_green.golden_axe:1}] if items entity @s container.* *[custom_data~{light_green.golden_dagger:1}] run scoreboard players add @s light_green.dagger_load 1
execute if items entity @s container.* *[custom_data~{light_green.golden_axe:1}] if items entity @s container.* *[custom_data~{light_green.golden_dagger:1}] if score @s light_green.dagger_load matches 55 unless score @s light_green.dagger_storage matches 18.. run scoreboard players add @s light_green.dagger_storage 1
execute if items entity @s container.* *[custom_data~{light_green.golden_axe:1}] if items entity @s container.* *[custom_data~{light_green.golden_dagger:1}] if score @s light_green.dagger_load matches 55 if score @s light_green.dagger_storage matches 18.. run scoreboard players add @s light_green.dagger_storage.ready_use 1
...
execute if items entity @s container.* *[custom_data~{light_green.golden_axe:1}] if items entity @s container.* *[custom_data~{light_green.golden_dagger:1}] if score @s light_green.dagger_load matches 55.. run scoreboard players reset @s light_green.dagger_load
