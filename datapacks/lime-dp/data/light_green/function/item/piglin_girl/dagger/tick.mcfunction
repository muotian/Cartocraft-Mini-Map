$data modify storage light_green:weapon player.$(id).dagger set from entity @s SelectedItem
$execute store result storage light_green:weapon player.$(id).dagger_damage double 0.01 run attribute @s attack_damage get 100

attribute @s minecraft:attack_damage modifier remove minecraft:effect.strength
attribute @s minecraft:attack_damage modifier remove minecraft:effect.weakness
...
execute if items entity @s container.* *[custom_data~{light_green.golden_axe:1}] if items entity @s container.* *[custom_data~{light_green.golden_spear:1}] run scoreboard players add @s light_green.dagger_load 1
execute if items entity @s container.* *[custom_data~{light_green.golden_axe:1}] if items entity @s container.* *[custom_data~{light_green.golden_spear:1}] if score @s light_green.dagger_load matches 55 unless score @s light_green.dagger_storage matches 18.. run scoreboard players add @s light_green.dagger_storage 1
