...
execute at @n[tag=light_green.summon.graud_golem] positioned ~-6 ~55 ~-6 align xyz positioned ~.5 ~ ~.5 run ride @n[tag=light_green.piglin_girl_npc.interaction] mount @n[tag=light_green.piglin_girl_npc]
