...
execute if score @s orange_timer matches 20 run effect give @s minecraft:glowing 2 1 true
execute if score @s orange_timer matches 20..60 at @s run particle minecraft:cloud ~ ~0.5 ~ 0.5 0.5 0.5 0.1 2

execute if score @s orange_timer matches 60 at @s facing entity @p eyes run tp @s ~ ~ ~ ~ ~

execute if score @s orange_timer matches 60 at @s run playsound minecraft:entity.wither.shoot ambient @a ~ ~ ~ 0.3 1.5

# ======================================================

execute if score @s orange_timer matches 60 at @s facing entity @p feet run function thecookieorange:mob/zombie/calculate_motion
...
execute if score @s orange_timer matches 100 at @s facing entity @p feet run tp @s ~ ~ ~

# ======================================================

execute if score @s orange_timer matches 140.. run scoreboard players set @s orange_timer 0
