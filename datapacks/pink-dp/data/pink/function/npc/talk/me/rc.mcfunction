#
advancement revoke @s only pink:npc/talk/me_talk1
...
scoreboard players set $talk pink.npc.talk 1

data modify storage pink:npc_talk max_line set value 5
data modify storage pink:npc_talk line_text set from storage pink:npc_talk _line_text[].me[1]
data modify storage pink:npc_talk type set value "me"


execute as @n[tag=pink_npc.talk.text,type=text_display] run function pink:npc/talk/talking1 with storage pink:npc_talk {}

# Name
data modify entity @n[tag=pink.npc.name] text set value {translate:"npc.pink.name",bold:true}
