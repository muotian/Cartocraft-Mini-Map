...
scoreboard players set $s pink.monster.death.skill 3
...
# dash
tag @s add this_m
execute as @e[tag=math_marker] at @s positioned as @n[tag=this_m] facing entity @p eyes rotated ~ 0 positioned 0.0 0.0 0.0 run tp @s ^ ^ ^2.2
