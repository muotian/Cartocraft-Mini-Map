# tag
tag @s remove pink.armor.black1

# 
execute unless items entity @s armor.chest *[custom_data~{pink_armor:1b,slot:"chest"}] run item replace entity @s armor.legs with air
effect clear @s resistance

# 
scoreboard players remove @s pink.armor.black.count 1
