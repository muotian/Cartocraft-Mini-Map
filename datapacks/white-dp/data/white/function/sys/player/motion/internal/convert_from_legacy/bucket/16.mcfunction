...
execute store result storage white:sys/player/motion/tmp convert double 0.897414 run scoreboard players get #crystal white.motion.internal.dummy
...
scoreboard players operation #crystal white.motion.internal.dummy += #convert.16.adder white.motion.internal.const