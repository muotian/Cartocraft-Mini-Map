...
execute store result storage white:sys/player/motion/tmp convert double 0.985704 run scoreboard players get #crystal white.motion.internal.dummy
...
scoreboard players operation #crystal white.motion.internal.dummy += #convert.07.adder white.motion.internal.const