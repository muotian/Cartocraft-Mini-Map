...
execute store result storage white:sys/player/motion/tmp convert double 1.012643 run scoreboard players get #crystal white.motion.internal.dummy
...
scoreboard players operation #crystal white.motion.internal.dummy += #convert.00.adder white.motion.internal.const