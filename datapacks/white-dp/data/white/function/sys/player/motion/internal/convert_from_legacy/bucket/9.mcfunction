...
execute store result storage white:sys/player/motion/tmp convert double 0.971299 run scoreboard players get #crystal white.motion.internal.dummy
...
scoreboard players operation #crystal white.motion.internal.dummy += #convert.09.adder white.motion.internal.const