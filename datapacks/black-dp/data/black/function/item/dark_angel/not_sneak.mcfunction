...
data modify entity @e[type=item_display,sort=nearest,limit=1,tag=black.summon] item.components."minecraft:custom_data".black.dark_angel_sneak set value 0b
data modify entity @e[type=item_display,sort=nearest,limit=1,tag=black.summon] item.components."minecraft:custom_model_data" set value {floats:[10]}
