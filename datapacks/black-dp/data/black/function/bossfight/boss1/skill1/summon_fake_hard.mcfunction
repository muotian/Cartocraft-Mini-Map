data merge entity @s {Glowing:1b,interpolation_duration:30,teleport_duration:1,Tags:["icebird.b1s1","icebird.b1s1_fake","icebird.b1s1_hard_orb"],glow_color_override:14652671,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[2f,2f,2f]},item:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{"properties":[{"name":"textures","value":"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjY3MTAzMjVhNzRkOTFmN2Y5MTUwZGQwY2VlNDlkMTE1ZTVmOGJhOWIzNjg4MzU2MTA4MDJmNGMyOTY2MTVlYyJ9fX0="}]}}}}
...
playsound black:ring block @a ~ ~ ~ 2 1.8