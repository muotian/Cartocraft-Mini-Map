schedule function black:bossfight/boss1/countdown_hard 1t
...
execute if score $phase icebird.boss1 matches 1 run scoreboard players add $boss1.skill1_hard icebird.boss1 1
execute if score $phase icebird.boss1 matches 3 run scoreboard players add $boss1.skill1_hard icebird.boss1 1
execute if score $phase icebird.boss1 matches 1 if score $boss1.skill1_hard icebird.boss1 matches 1000 run function black:bossfight/boss1/skill1/ini_hard
execute if score $phase icebird.boss1 matches 3 if score $boss1.skill1_hard icebird.boss1 matches 1000 run function black:bossfight/boss1/skill1/ini_hard
