...
execute at @n[tag=black.boss1_center] run summon mannequin ~5 ~ ~-6 {Silent:1b,Invulnerable:1b,immovable:true,Tags:["icebird.boss1_spirit","icebird.boss1_spirit.talk","icebird.boss_spirit"],profile:"jakY1299"}
