execute as @e[tag=wool_purple.npc.alchemist1,type=interaction] at @s run function ordered_splinter:npc/alchemist1/process_click
execute as @e[tag=wool_purple.npc.alchemist1_mannequin,type=mannequin] at @s run function ordered_splinter:npc/alchemist1/mannequin_tick
execute as @e[tag=wool_purple.npc.alchemist1.dialog.branch.1,type=interaction] at @s run function ordered_splinter:npc/alchemist1/process_branch1
execute as @e[tag=wool_purple.npc.alchemist1.dialog.branch.2,type=interaction] at @s run function ordered_splinter:npc/alchemist1/process_branch2
