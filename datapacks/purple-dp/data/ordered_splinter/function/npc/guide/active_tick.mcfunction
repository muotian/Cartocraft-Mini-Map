execute as @e[tag=wool_purple.npc.guide,type=interaction] at @s run function ordered_splinter:npc/guide/process_click
execute as @e[tag=wool_purple.npc.guide_mannequin,type=mannequin] at @s run function ordered_splinter:npc/guide/mannequin_tick
execute as @e[tag=wool_purple.npc.guide.dialog.branch.1,type=interaction] at @s run function ordered_splinter:npc/guide/process_branch1
execute as @e[tag=wool_purple.npc.guide.dialog.branch.2,type=interaction] at @s run function ordered_splinter:npc/guide/process_branch2
