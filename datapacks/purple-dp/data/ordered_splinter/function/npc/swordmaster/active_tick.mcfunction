execute as @e[tag=wool_purple.npc.swordmaster,type=interaction] at @s run function ordered_splinter:npc/swordmaster/process_click
execute as @e[tag=wool_purple.npc.swordmaster_mannequin,type=mannequin] at @s run function ordered_splinter:npc/swordmaster/mannequin_tick
execute as @e[tag=wool_purple.npc.swordmaster.dialog.branch.1,type=interaction] at @s run function ordered_splinter:npc/swordmaster/process_branch1
execute as @e[tag=wool_purple.npc.swordmaster.dialog.branch.2,type=interaction] at @s run function ordered_splinter:npc/swordmaster/process_branch2
