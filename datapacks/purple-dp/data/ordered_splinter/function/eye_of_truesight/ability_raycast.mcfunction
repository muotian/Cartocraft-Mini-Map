...
execute anchored eyes run particle gust ^ ^ ^ 0.0005 0.0005 0.0005 0.00001 1 force @a
execute anchored eyes run particle gust ^ ^ ^0.125 0.0005 0.0005 0.0005 0.00001 1 force @a
execute anchored eyes run particle ominous_spawning ^ ^ ^ 0.1 0.1 0.1 0.00001 15 force @a
