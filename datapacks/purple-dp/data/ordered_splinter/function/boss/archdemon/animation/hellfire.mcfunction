...
# 射線在 5 結束，在 4 即刻清除目標標籤，並在 0 與 <=0 徹底防護清理
execute if score @s wool_purple.boss_animation matches 4 run tag @e[tag=wool_purple.hellfire_target] remove wool_purple.hellfire_target
execute if score @s wool_purple.boss_animation matches 4 run tag @a[tag=wool_purple.hellfire_target] remove wool_purple.hellfire_target
...
execute if score @s wool_purple.boss_animation matches ..0 run tag @a[tag=wool_purple.hellfire_target] remove wool_purple.hellfire_target
