...
$execute store result storage give:weapon common_chance_max int 1 run scoreboard players set $chance wool_purple.main.math $(common)
...
$scoreboard players set $increase_chance wool_purple.main.math $(handy)
...
$scoreboard players set $increase_chance wool_purple.main.math $(fine)
...
$scoreboard players set $increase_chance wool_purple.main.math $(superior)
...
$scoreboard players set $increase_chance wool_purple.main.math $(masterwork)
