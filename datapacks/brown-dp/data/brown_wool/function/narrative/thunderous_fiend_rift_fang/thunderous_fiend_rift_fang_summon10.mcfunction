...
execute at @n[type=marker,tag=brown_wool.thunderous_fiend_rift_fang.terrain] rotated ~ 0 run summon minecraft:interaction ~ ~0.742 ~-1.1 {Tags:["brown_wool.thunderous_fiend_rift_fang.narrative13.0","brown_wool.narrative0.0","brown_wool.thunderous_fiend_rift_fang.narrative00"],height:0.5,width:0.8,response:true}
