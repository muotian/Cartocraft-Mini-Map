...
kill @e[type=stray, tag=brown_wool.xuan_ting_priest0]
...
kill @e[type=block_display, tag=brown_wool.xuan_ting_priest.skill1.0]
...
kill @e[tag=brown_wool.xuan_ting_priest.end0]
