...
execute if score @s brown_wool.thunderous_fiend_rift_fang_2.cast4 matches 30.. at @s as @p[tag=brown_wool.thunderous_fiend_rift_fang.player,distance=..8.2] run effect give @s slowness 1 3 true

execute if score @s brown_wool.thunderous_fiend_rift_fang_2.cast4 matches 30.. facing entity @p[tag=brown_wool.thunderous_fiend_rift_fang.player] feet run function brown_wool:entity/boss/thunderous_fiend_rift_fang_2/cast4.2
