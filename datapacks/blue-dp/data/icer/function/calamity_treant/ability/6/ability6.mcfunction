...
tag @s add icer.using_ability6
#切換狀態

data merge entity @s {NoAI:1b}
#將boss定身

execute as @n[tag=aj.calamity_treant.root] run function animated_java:calamity_treant/animations/calamity_treant_ability6/play
#播放技能動畫
