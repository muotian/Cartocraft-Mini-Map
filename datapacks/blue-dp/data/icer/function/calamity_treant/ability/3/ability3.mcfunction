execute as @n[tag=aj.calamity_treant.root] run function animated_java:calamity_treant/animations/calamity_treant_ability3/play
#播放使用技能動畫

scoreboard players remove @s icer.boss_mana 30
#消耗掉魔力值

playsound block.beacon.activate ambient @a ~ ~ ~
#播放音效

tag @s add icer.using_ability3
